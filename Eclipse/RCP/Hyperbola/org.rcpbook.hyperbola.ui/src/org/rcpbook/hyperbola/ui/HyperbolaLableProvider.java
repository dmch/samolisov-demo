...
public class HyperbolaLableProvider extends LabelProvider {
    ...
    protected final IWorkbenchAdapter getAdapter(Object element) {
        ...
        if (adapter == null)
            adapter = (IWorkbenchAdapter) Platform.getAdapterManager().loadAdapter(element, 
            		IWorkbenchAdapter.class.getName());
        return adapter;
    }
