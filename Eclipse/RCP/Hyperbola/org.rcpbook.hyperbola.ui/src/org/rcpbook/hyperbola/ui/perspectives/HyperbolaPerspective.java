...
public class HyperbolaPerspective implements IPerspectiveFactory {

	public void createInitialLayout(IPageLayout layout) {
		layout.setEditorAreaVisible(true);
		layout.addStandaloneView(ContactsView.ID, false, IPageLayout.LEFT, 0.4f, layout.getEditorArea());
		
		layout.addPerspectiveShortcut(DebugPerspective.ID);
		layout.addPerspectiveShortcut(FreeMovingPerspective.ID);
	}
}
